...
!-----------------------------------------------------------------------
!
      logical synchro_flag,synchro_flag_tair,synchro_flag_rhum,
     &        synchro_flag_rad, synchro_flag_wspd, synchro_flag_uwnd,
     &        synchro_flag_vwnd,synchro_flag_prate

      common /sync_flag/ synchro_flag,synchro_flag_tair,synchro_flag_rhum,
     &        synchro_flag_rad, synchro_flag_wspd, synchro_flag_uwnd,
     &        synchro_flag_vwnd,synchro_flag_prate
