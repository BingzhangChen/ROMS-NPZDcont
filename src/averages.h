...
# if defined PZEFTFE || defined BIO_PZEFT
      real dust_avg(GLOBAL_2D_ARRAY)
      common /avg_dust/dust_avg
# endif
# ifdef SOLVE3D
...
#   if defined BIO_PZEFT || defined PZEFTFE
      real Qbulk_avg(GLOBAL_2D_ARRAY,N)
      real Thetabulk_avg(GLOBAL_2D_ARRAY,N)
      common /Qbulk_avg/Qbulk_avg
      common /Thetabulk_avg/Thetabulk_avg
